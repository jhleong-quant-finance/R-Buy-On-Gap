...
nStockTradeVec_SD_r2k_APYBT_2day <- list();
conditionsMet_SD_r2k_APYBT_2day <- list();
tradeMat_SD_r2k_APYBT_2day <- list();
...
for(stdLookback in c(66)){
  for(stdMultiple in c(0.5,1)){
    ...
    for(nStocksBuy in c(1,4,8,10,60))
    {
      ...
      if(nStocksBuy == 10)
      {
        conditionsMet_SD_r2k_APYBT_2day[[as.character(nskip)]][[as.character(stdLookback)]][[as.character(stdMultiple)]] <- conditionsMet;
        tradeMat_SD_r2k_APYBT_2day[[as.character(nskip)]][[as.character(stdLookback)]][[as.character(stdMultiple)]] <- tradeMat;
      }
    ...
    nStockTradeVec_SD_r2k_APYBT_2day[[as.character(nskip)]][[as.character(stdLookback)]][[as.character(stdMultiple)]] <- nStockTradeVec
  }
}

save(nStockTradeVec_SD_r2k_APYBT_2day, 
     conditionsMet_SD_r2k_APYBT_2day,
     tradeMat_SD_r2k_APYBT_2day,
     file='/home/jhleong/dev/R/buy_on_gap/result_Rdata/nStockTradeVec_SD_r2k_APYBT_2day.Rdata' );
rm(nStockTradeVec_SD_r2k_APYBT_2day,conditionsMet_SD_r2k_APYBT_2day,tradeMat_SD_r2k_APYBT_2day);
gc();
